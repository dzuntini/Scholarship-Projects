...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/09 23:08:08 by dzuntini          #+#    #+#             */
/*   Updated: 2021/10/10 18:38:45 by dzuntini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_substr(char *str, int *i, t_data *ms)
{
	char	*value;
	char	*key;
	int		i_key;
